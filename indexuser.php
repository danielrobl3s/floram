...
<body>
      ...
      <nav class="navbar navbar-expand-lg custom_nav-container ">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav  ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="contact.php">Rate us!</a>
            </li>
            <div class="btn-box">
              <a href="index.html">Welcome back! <?php echo $_SESSION["name"]?></a>
            </div>
          </ul>
        </div>
      </nav>
            ...
            <div class="row">
              <div class="col-md-6 col-lg-5">
                <div class="detail-box">
                  ...
                  <p>
                    As trusty as your local convenience store ;) </p>
                  <div class="btn-box">
                    <a href="" class="btn-1">
                      Read More
                    </a>
  ...
  <section class="product_section layout_padding">
    <div class="container">
      ...
      <div class="btn-box">
        <a href="cms/commentform.php">Edit inventory</a>
      </div>
      <div class="btn-box">
        <a href="">
          View All
